local webhook = "https://discord.com/api/webhooks/1059598108679491655/HtohOGDHViUc_1NtBixagkwHu3NuPugqLiIWPh-5stW-7BZL9BYG1Cd6HvvWqWSaIvqs"



RegisterCommand("combat", function(source, args, rawcmd)
    TriggerClientEvent("aendir_antiCL:show", source)
end)
...
AddEventHandler("playerDropped", function(reason)
    ...
    TriggerClientEvent("aendir_anticl", -1, id, crds, identifier, reason)
